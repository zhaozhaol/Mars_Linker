...
public final class ClientSessionContext {
    ...
    private static final AttributeKey<String> CLOSE_REASON = AttributeKey.valueOf("mqtt_close_reason");
    ...
    private static final AttributeKey<ScheduledFuture<?>> KEEPALIVE_TASK = AttributeKey.valueOf("mqtt_keepalive_task");
